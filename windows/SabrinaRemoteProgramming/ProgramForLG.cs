...
namespace BLEWriteCharacteristic
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            result = await WriteCharacteristicAsync("d343bfc3-5a21-4f05-bc7d-af01f617b664", "");
            Console.WriteLine(result ? "Write successful." : "Write failed.");
            ...
            result = await WriteCharacteristicAsync("d343bfc3-5a21-4f05-bc7d-af01f617b664", "");
            Console.WriteLine(result ? "Write successful." : "Write failed.");
            ...
            result = await WriteCharacteristicAsync("d343bfc3-5a21-4f05-bc7d-af01f617b664", "");
            Console.WriteLine(result ? "Write successful." : "Write failed.");
            ...
            result = await WriteCharacteristicAsync("d343bfc3-5a21-4f05-bc7d-af01f617b664", "");
            Console.WriteLine(result ? "Write successful." : "Write failed.");
            ...
            result = await WriteCharacteristicAsync("d343bfc3-5a21-4f05-bc7d-af01f617b664", "");
            Console.WriteLine(result ? "Write successful." : "Write failed.");
