...
device.writeCharacteristic(0x004f, b'\x01', True)
device.writeCharacteristic(0x0051, b'\x00\x19', True)
device.writeCharacteristic(0x0053, bytes.fromhex(""), True)
device.writeCharacteristic(0x004f, b'\x00', True)
