...
device.writeCharacteristic(0x0054, b'\x01', True)

device.writeCharacteristic(0x0056, b'\x00\x1a', True)
device.writeCharacteristic(0x0058, bytes.fromhex(""), True)

device.writeCharacteristic(0x0056, b'\x00\xb2', True)
device.writeCharacteristic(0x0058, bytes.fromhex(""), True)

device.writeCharacteristic(0x0054, b'\x00', True)
